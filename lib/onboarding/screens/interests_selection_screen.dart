...
import 'package:unlock/onboarding/widgets/interest_chip_grid.dart';
import 'package:unlock/onboarding/widgets/onboarding_progress_bar.dart';
import 'package:unlock/onboarding/widgets/step_navigation_buttons.dart';
  ...
  Future<void> _handleComplete() async {
    ...
    try {
      ...
      if (success) {
        ...
        context.go('/home'); // Redireciona para a home após sucesso
      } else {
        // ✅ Mostrar erro
        _showErrorSnackBar();
      }
